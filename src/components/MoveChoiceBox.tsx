...
export const MoveChoiceBox: React.FC<MoveChoiceBoxProps> = ({
  ...
  const handleChoice = async (btnIndex: number) => {
  ...
  return (
    <div className="relative inline-flex items-center">
          ...
          <>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                >
                  {status === 'sending' && selectedBtn === 0 ? (
                    <Loader2 className="w-3.5 h-3.5 animate-spin" />
                  ) : selectedBtn === 0 && status === 'sent' ? (
                ...
                >
                  {status === 'sending' && selectedBtn === 1 ? (
                    <Loader2 className="w-3.5 h-3.5 animate-spin" />
                  ) : selectedBtn === 1 && status === 'sent' ? (
                    <Check className="w-3.5 h-3.5 stroke-[3]" />
                  ) : null}
                  yes
                </motion.button>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.92 }}
        onClick={onToggle}
        title={isOpen ? 'Close' : 'Do you want me to ask you out?'}
        aria-label="Do you want me to ask you out?"
