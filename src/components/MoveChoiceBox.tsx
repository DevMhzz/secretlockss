...
import { BowArrow, X, Heart } from 'lucide-react';
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute bottom-full left-0 mb-3 z-50 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl shadow-pink-200/50 border-2 border-pink-200 text-pink-900 min-w-[230px] max-w-[270px] sm:max-w-xs select-none"
            >
              ...
              {/* Reminder Text */}
              <p className="text-sm font-bold text-pink-900 tracking-tight leading-snug">
                stay sleepy pooks when u sleep yk 😴
              </p>
